//
//  PersonalInfoPreviousButton.swift
//  SignUpApp
//
...
class PersonalInfoNextButton: UIButton {
    ...
    private func setupNotification() {
        NotificationCenter.default.addObserver(self,
                                               ...
                                               name: PersonalInfoViewModel.PersonalInfoValidationDidChangeNotification,
                                               object: nil)
    }
    ...
    deinit {
        NotificationCenter.default.removeObserver(self, name: PersonalInfoViewModel.PersonalInfoValidationDidChangeNotification, object: nil)
    }
}
